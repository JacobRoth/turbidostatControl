...
// Digital Pins
const int ledPin = 5;
const int airflowPin = 2; //const int clampPin = 3; // I renamed this since we moved from a pinch valve to a solid state relay to control airflow
